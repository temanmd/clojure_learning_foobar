...
var vec__9358 = cljs.core.rest(expr);
var seq__9359 = cljs.core.seq(vec__9358);
var first__9360 = cljs.core.first(seq__9359);
var seq__9359__$1 = cljs.core.next(seq__9359);
var vec__9361 = first__9360;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9361,(0),null);
var form = seq__9359__$1;
...
var G__9367 = x;
var G__9367__$1 = (((G__9367 == null))?null:spec_tools.impl.polish(G__9367));
var G__9367__$2 = (((G__9367__$1 == null))?null:cljs.core.name(G__9367__$1));
if((G__9367__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__9367__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__9368 = x;
var G__9368__$1 = (((G__9368 == null))?null:cljs.core.name(G__9368));
if((G__9368__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__9368__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__9373){
var map__9374 = p__9373;
var map__9374__$1 = cljs.core.__destructure_map(map__9374);
var data = map__9374__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9374__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9374__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9374__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9374__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__9375){
var map__9376 = p__9375;
var map__9376__$1 = cljs.core.__destructure_map(map__9376);
var data = map__9376__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9376__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9376__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__9377 = data;
var G__9377__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__9377,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__9377);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__9377__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__9377__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__9381 = form;
var G__9381__$1 = (((G__9381 == null))?null:cljs.core.rest(G__9381));
if((G__9381__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__9381__$1);
}
})();
var G__9382 = m;
var G__9382__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__9382,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__9378_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__9378_SHARP_)));
})):G__9382);
var G__9382__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__9382__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__9379_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__9379_SHARP_)));
})):G__9382__$1);
var G__9382__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__9382__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__9380_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__9380_SHARP_));
})):G__9382__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__9382__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__9383 = (function (){var G__9384 = form;
var G__9384__$1 = (((G__9384 == null))?null:cljs.core.rest(G__9384));
if((G__9384__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__9384__$1);
}
})();
var map__9383__$1 = cljs.core.__destructure_map(map__9383);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9383__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9383__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9383__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9383__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__9390 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__9403 = form;
var G__9403__$1 = (((G__9403 == null))?null:cljs.core.seq(G__9403));
var G__9403__$2 = (((G__9403__$1 == null))?null:cljs.core.first(G__9403__$1));
if((G__9403__$2 == null)){
return null;
} else {
var fexpr__9407 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__9407.cljs$core$IFn$_invoke$arity$1 ? fexpr__9407.cljs$core$IFn$_invoke$arity$1(G__9403__$2) : fexpr__9407.call(null,G__9403__$2));
}
})():null));
});
/**
...
var len__5769__auto___9522 = arguments.length;
var i__5770__auto___9523 = (0);
while(true){
if((i__5770__auto___9523 < len__5769__auto___9522)){
args__5775__auto__.push((arguments[i__5770__auto___9523]));

var G__9524 = (i__5770__auto___9523 + (1));
i__5770__auto___9523 = G__9524;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq9412){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq9412));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__9426){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__9457){
var map__9458 = p__9457;
var map__9458__$1 = cljs.core.__destructure_map(map__9458);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9458__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9458__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9458__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9458__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__9455_SHARP_){
return cljs.core.map_QMARK_(p1__9455_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__9456_SHARP_){
return cljs.core.contains_QMARK_(p1__9456_SHARP_,x);
});
}),req_keys));
