...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__10840 = cljs.core.get_global_hierarchy;
return (fexpr__10840.cljs$core$IFn$_invoke$arity$0 ? fexpr__10840.cljs$core$IFn$_invoke$arity$0() : fexpr__10840.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__10855){
var map__10856 = p__10855;
var map__10856__$1 = cljs.core.__destructure_map(map__10856);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10856__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10856__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__10857 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10857,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10857,(1),null);
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__10864 = cljs.core.get_global_hierarchy;
return (fexpr__10864.cljs$core$IFn$_invoke$arity$0 ? fexpr__10864.cljs$core$IFn$_invoke$arity$0() : fexpr__10864.call(null));
})());
...
var map__10866 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__10866__$1 = cljs.core.__destructure_map(map__10866);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10866__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10866__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__10867){
var vec__10868 = p__10867;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10868,(0),null);
var map__10871 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10868,(1),null);
var map__10871__$1 = cljs.core.__destructure_map(map__10871);
var schema = map__10871__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10871__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__10873 = cljs.core.get_global_hierarchy;
return (fexpr__10873.cljs$core$IFn$_invoke$arity$0 ? fexpr__10873.cljs$core$IFn$_invoke$arity$0() : fexpr__10873.call(null));
})());
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$swagger$core$iter__10874(s__10875){
return (new cljs.core.LazySeq(null,(function (){
var s__10875__$1 = s__10875;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__10875__$1);
if(temp__5804__auto__){
var s__10875__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10875__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__10875__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__10877 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__10876 = (0);
while(true){
if((i__10876 < size__5522__auto__)){
var vec__10879 = cljs.core._nth(c__5521__auto__,i__10876);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10879,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10879,(1),null);
cljs.core.chunk_append(b__10877,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10877),spec_tools$swagger$core$iter__10874(cljs.core.chunk_rest(s__10875__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10877),null);
}
} else {
var vec__10882 = cljs.core.first(s__10875__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10882,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10882,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__10874(cljs.core.rest(s__10875__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__10886){
var vec__10887 = p__10886;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10887,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10887,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__10890,p){
var vec__10891 = p__10890;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10891,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10891,(1),null);
var acc__$1 = vec__10891;
