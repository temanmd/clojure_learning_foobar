...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11973 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11973(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11979 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11979(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11990 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11990(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11997 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11997(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12000 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12000(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12010 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12010(reader);
}
});
...
var G__12118 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12119 = s.append(c);
c = G__12118;
s = G__12119;
continue;
}
