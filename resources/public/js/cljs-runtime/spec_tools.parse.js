...
var fexpr__9490 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__9490.cljs$core$IFn$_invoke$arity$1 ? fexpr__9490.cljs$core$IFn$_invoke$arity$1(type) : fexpr__9490.call(null,type));
});
...
var G__9519 = spec_tools.impl.normalize_symbol(x);
var G__9520 = null;
var G__9521 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__9519,G__9520,G__9521) : spec_tools.parse.parse_form.call(null,G__9519,G__9520,G__9521));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__9525 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__9526 = x;
var G__9527 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__9525,G__9526,G__9527) : spec_tools.parse.parse_form.call(null,G__9525,G__9526,G__9527));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__9609 = cljs.spec.alpha.form(x);
var G__9610 = options;
x = G__9609;
options = G__9610;
continue;
...
var G__9528 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__9529 = null;
var G__9530 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__9528,G__9529,G__9530) : spec_tools.parse.parse_form.call(null,G__9528,G__9529,G__9530));
} else {
...
var G__9533 = parse_data;
var G__9533__$1 = (((G__9533 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__9533));
var G__9533__$2 = (((G__9533__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__9533__$1));
var G__9533__$3 = (((G__9533__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__9533__$2));
var G__9533__$4 = (((G__9533__$3 == null))?null:cljs.core.seq(G__9533__$3));
if((G__9533__$4 == null)){
return null;
} else {
return cljs.core.set(G__9533__$4);
}
}
});
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__9542 = cljs.core.get_global_hierarchy;
return (fexpr__9542.cljs$core$IFn$_invoke$arity$0 ? fexpr__9542.cljs$core$IFn$_invoke$arity$0() : fexpr__9542.call(null));
})());
...
var map__9575 = spec_tools.impl.parse_keys(form);
var map__9575__$1 = cljs.core.__destructure_map(map__9575);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9575__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9575__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9575__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9575__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9575__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__9576 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__9576__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9576,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__9576);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9576__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__9576__$1;
}
}));
...
var vec__9577 = multi_spec_form;
var seq__9578 = cljs.core.seq(vec__9577);
var first__9579 = cljs.core.first(seq__9578);
var seq__9578__$1 = cljs.core.next(seq__9578);
var _ = first__9579;
var first__9579__$1 = cljs.core.first(seq__9578__$1);
var seq__9578__$2 = cljs.core.next(seq__9578__$1);
var multi_method_symbol = first__9579__$1;
var ___$1 = seq__9578__$2;
var form = vec__9577;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__9580){
var vec__9581 = p__9580;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9581,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9581,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__9584_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__9584_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__9585_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__9585_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__9586_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__9586_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9587_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__9587_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__9588 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__9588__$1 = cljs.core.__destructure_map(map__9588);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9588__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__9592 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__9592__$1 = cljs.core.__destructure_map(map__9592);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9592__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__9595,options){
var vec__9596 = p__9595;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9596,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9596,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9596,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__9600,options){
...
var ___$1 = first__9603;
var values = seq__9602__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__9599_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__9599_SHARP_,options);
}),values);
...
var type_priority = (function (p1__9604_SHARP_){
var G__9607 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__9606 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__9604_SHARP_);
return (fexpr__9606.cljs$core$IFn$_invoke$arity$1 ? fexpr__9606.cljs$core$IFn$_invoke$arity$1(G__9607) : fexpr__9606.call(null,G__9607));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9605_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__9605_SHARP_,options);
}),cljs.core.rest(form))));
}));
