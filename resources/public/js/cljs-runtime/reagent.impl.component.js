...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21667 = c;
var G__21667__$1 = (((G__21667 == null))?null:G__21667.prototype);
if((G__21667__$1 == null)){
return null;
} else {
return G__21667__$1.reagentRender;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__21676 = c;
var G__21676__$1 = (((G__21676 == null))?null:G__21676.constructor);
if((G__21676__$1 == null)){
return null;
} else {
return G__21676__$1.displayName;
}
})();
...
var G__21677 = c;
var G__21677__$1 = (((G__21677 == null))?null:G__21677.constructor);
if((G__21677__$1 == null)){
return null;
} else {
return G__21677__$1.name;
}
}
});
...
var c = this;
var G__21741_21771 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21741_21771 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21741_21771);
}
...
var renders_21772 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21773 = cljs.core.first(cljs.core.vals(renders_21772));
...
if((cljs.core.count(renders_21772) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21772))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21773)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21773], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21753 = o;
reagent.impl.component.goog$module$goog$object.set(G__21753,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21754 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21755 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21755);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21754);
}});
...
var vec__21756 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21756,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21756,(1),null);
...
var G__21759 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21759 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21759);
}
});
}),[]);
