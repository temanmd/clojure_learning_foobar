...
var G__21781 = o;
reagent.impl.template.goog$module$goog$object.set(G__21781,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21799__delegate = function (args){
...
while (G__21800__i < G__21800__a.length) {G__21800__a[G__21800__i] = arguments[G__21800__i + 0]; ++G__21800__i;}
  args = new cljs.core.IndexedSeq(G__21800__a,0,null);
} 
return G__21799__delegate.call(this,args);};
G__21799.cljs$lang$maxFixedArity = 0;
G__21799.cljs$lang$applyTo = (function (arglist__21801){
var args = cljs.core.seq(arglist__21801);
return G__21799__delegate(args);
});
...
var G__21782 = o;
reagent.impl.template.goog$module$goog$object.set(G__21782,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21802__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__21803__i < G__21803__a.length) {G__21803__a[G__21803__i] = arguments[G__21803__i + 0]; ++G__21803__i;}
  args = new cljs.core.IndexedSeq(G__21803__a,0,null);
} 
return G__21802__delegate.call(this,args);};
G__21802.cljs$lang$maxFixedArity = 0;
G__21802.cljs$lang$applyTo = (function (arglist__21804){
var args = cljs.core.seq(arglist__21804);
return G__21802__delegate(args);
});
...
var G__21783 = props;
var G__21783__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21783,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21783);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21783__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21784 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21784,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21784;
}
})(),id_class);
...
var G__21785 = (cljs.core.count(argv) - first_child);
switch (G__21785) {
case (0):
...
var vec__21786 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21786,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21786,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21786,(2),null);
...
var temp__5808__auto___21810 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21810 == null)){
} else {
var key_21811 = temp__5808__auto___21810;
(jsprops.key = key_21811);
}
...
var temp__5808__auto___21816 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21816 == null)){
} else {
var key_21817 = temp__5808__auto___21816;
(jsprops.key = key_21817);
}
...
var temp__5808__auto___21820 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21820 == null)){
} else {
var key_21821 = temp__5808__auto___21820;
(jsprops.key = key_21821);
}
...
var temp__5808__auto___21828 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21828 == null)){
} else {
var key_21829 = temp__5808__auto___21828;
(jsprops.key = key_21829);
}
...
var temp__5808__auto___21834 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21834 == null)){
} else {
var key_21836 = temp__5808__auto___21834;
(jsprops.key = key_21836);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21789_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21789_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21790 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21790,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21790,(1),null);
...
break;
default:
var G__21846 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21847 = compiler;
v = G__21846;
compiler = G__21847;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21796 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21796 = (function (opts,id,fn_to_element,parse_fn,meta21797){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21796.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21798,meta21797__$1){
var self__ = this;
var _21798__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21796(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21797__$1));
}));

(reagent.impl.template.t_reagent$impl$template21796.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21798){
var self__ = this;
var _21798__$1 = this;
return self__.meta21797;
}));

(reagent.impl.template.t_reagent$impl$template21796.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21796.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21796.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21796.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21796.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21796.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21797","meta21797",-1330658865,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21796.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21796.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21796");

(reagent.impl.template.t_reagent$impl$template21796.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template21796");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21796.
 */
reagent.impl.template.__GT_t_reagent$impl$template21796 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21796(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21797){
return (new reagent.impl.template.t_reagent$impl$template21796(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21797));
});

}

return (new reagent.impl.template.t_reagent$impl$template21796(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
