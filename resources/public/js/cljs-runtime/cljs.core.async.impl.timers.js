...
var i_13675 = (0);
while(true){
if((i_13675 < arr.length)){
(arr[i_13675] = null);

var G__13677 = (i_13675 + (1));
i_13675 = G__13677;
continue;
} else {
}
...
var i_13698 = (self__.level + (1));
while(true){
if((i_13698 <= (new_level + (1)))){
(update[i_13698] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13703 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13703[i]));
} else {
x__$2.forward.push((((i < links_13703.length))?(links_13703[i]):null));
}

if((i < links_13703.length)){
(links_13703[i] = x__$2);
} else {
links_13703.push(x__$2);
}
...
var i_13712 = (0);
while(true){
if((i_13712 <= self__.level)){
var links_13713 = (update[i_13712]).forward;
if((x__$1 === (((i_13712 < links_13713.length))?(links_13713[i_13712]):null))){
(links_13713[i_13712] = (x__$1.forward[i_13712]));

var G__13716 = (i_13712 + (1));
i_13712 = G__13716;
continue;
} else {
var G__13718 = (i_13712 + (1));
i_13712 = G__13718;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__13738 = nx;
var G__13739 = (level__$1 - (1));
x = G__13738;
level__$1 = G__13739;
continue;
} else {
var G__13744 = x;
var G__13745 = (level__$1 - (1));
x = G__13744;
level__$1 = G__13745;
continue;
}
