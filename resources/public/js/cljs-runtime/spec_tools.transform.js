...
if((x instanceof cljs.core.Keyword)){
var G__9619 = spec;
var G__9620 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__9623 = spec;
var G__9624 = spec_tools.transform.keyword__GT_string(spec,x);
...
if(typeof x === 'number'){
var G__9625 = spec;
var G__9626 = spec_tools.transform.number__GT_string(spec,x);
...
}catch (e9628){if((e9628 instanceof Error)){
var ___$1 = e9628;
return x;
} else {
throw e9628;
...
}catch (e9629){if((e9629 instanceof Error)){
var ___$1 = e9629;
return x;
} else {
throw e9629;
...
}catch (e9630){if((e9630 instanceof Error)){
var ___$1 = e9630;
return x;
} else {
throw e9630;
...
}catch (e9631){if((e9631 instanceof Error)){
var ___$1 = e9631;
return x;
} else {
throw e9631;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__9635,x){
var map__9636 = p__9635;
var map__9636__$1 = cljs.core.__destructure_map(map__9636);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9636__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
if(cljs.core.truth_((function (){var and__5043__auto__ = keys;
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__9637,x){
var map__9638 = p__9637;
var map__9638__$1 = cljs.core.__destructure_map(map__9638);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9638__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__9640,x){
var map__9641 = p__9640;
var map__9641__$1 = cljs.core.__destructure_map(map__9641);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9641__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
