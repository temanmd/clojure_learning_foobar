...
var len__5769__auto___13662 = arguments.length;
var i__5770__auto___13664 = (0);
while(true){
if((i__5770__auto___13664 < len__5769__auto___13662)){
args_arr__5794__auto__.push((arguments[i__5770__auto___13664]));

var G__13665 = (i__5770__auto___13664 + (1));
i__5770__auto___13664 = G__13665;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq13579){
...
var G__13582 = cljs.core.first(seq13579__$2);
var seq13579__$3 = cljs.core.next(seq13579__$2);
var G__13583 = cljs.core.first(seq13579__$3);
var seq13579__$4 = cljs.core.next(seq13579__$3);
var G__13584 = cljs.core.first(seq13579__$4);
var seq13579__$5 = cljs.core.next(seq13579__$4);
var G__13585 = cljs.core.first(seq13579__$5);
var seq13579__$6 = cljs.core.next(seq13579__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13580,G__13581,G__13582,G__13583,G__13584,G__13585,seq13579__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__13626){
var vec__13628 = p__13626;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13628,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13628,(1),null);
